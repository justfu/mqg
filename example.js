    ...
    var actionsheet = {
        ...
        bind: function () {
            $('#container').on('click', '#showActionSheet', function () {
                ...
                $('#actionsheet_cancel1').one('click', function () {
                    hideActionSheet(weuiActionsheet, mask);
                    $('#loadingToast').show();
                    setTimeout(function () {
                        $('#loadingToast').hide();
                ...
                $('#actionsheet_cancel2').one('click', function () {
                    hideActionSheet(weuiActionsheet, mask);
                    $('#loadingToast').show();
                    setTimeout(function () {
                        $('#loadingToast').hide();
                ...
                $('#actionsheet_cancel3').one('click', function () {
                    hideActionSheet(weuiActionsheet, mask);
                    $('#loadingToast').show();
                    setTimeout(function () {
                        $('#loadingToast').hide();
                ...
                $('#actionsheet_cancel4').one('click', function () {
                    hideActionSheet(weuiActionsheet, mask);
                    $('#loadingToast').show();
                    setTimeout(function () {
                        $('#loadingToast').hide();
                ...
                $('#actionsheet_cancel5').one('click', function () {
                    hideActionSheet(weuiActionsheet, mask);
                    $('#loadingToast').show();
                    setTimeout(function () {
                        $('#loadingToast').hide();
